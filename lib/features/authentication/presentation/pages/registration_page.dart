...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  void _onSendOtp() {
    ...
    if (_usePhone) {
      context.read<AuthBloc>().add(AuthSignInWithPhoneRequested(value));
    } else {
      // Email sign-up: navigate directly to details, OTP not needed for email
    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthOtpSent) {
          context.push(AppRoutes.registrationOtp.path, extra: state.phone);
